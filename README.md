...
Want to make your app faster?
Don't want to spend more on infrastructure?
Want more predictable traffic loads accross your ecosystem? 
[Learn how](https://github.com/fed135/ha-store/wiki) you can do it with HA-store!
...
--- | --- | --- | ---
resolver | true | - | The method to wrap, and how to interpret the returned data. Uses the format `<function(ids, params, context)>`
...
You may also want to track the amount of `records` stored via the `size` method.
